...
import "./AssortedComparisonChart.css"; // Adjust path to your CSS file

const AssortedComparisonChart = () => {
  ...
  return (
    <div className="chart-container">
      <h1 className="chart-header">Customer Bill Comparison</h1>
...
export default AssortedComparisonChart;
